...
const Sidebar = () => {
	return (
		<div className="d-flex flex-wrap pt-2 pt-sm-0 flex-sm-column justify-content-evenly justify-content-sm-start align-items-center align-items-md-start h-100 bg-dark text-light text-center text-md-start">
