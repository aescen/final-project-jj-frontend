    ...
    >
      <div className='container pb-5'>
        {isLoading ? (
          ...
          <>
            <div className='fs-3 fw-semibold text-uppercase text-center mb-5 mt-5'>
            ...
            <div className='row'>
                  ...
                  <>
                    ...
                    >
                      {product.designPhotos.map((item, idx) => (
                        <Carousel.Item
                          key={idx}
                          className='border border-5 border-secondary p-0'
                        >
                          <img
                    ...
                    <div className='row p-0 m-0'>
                      {product.designPhotos.map((item, idx) => (
                        <div
                          className='col-4 p-0 m-0 border border-5 border-secondary p-0'
                          key={idx}
                        >
                          <img
                            className='d-block w-100 p-0 m-0 detail-thumb'
                            key={idx}
                            src={item}
              ...
              <div className='col-12 col-md-4 mt-5 mt-md-0 text-start ps-4'>
                ...
                <div className='fs-6 mb-5 text-break'>
